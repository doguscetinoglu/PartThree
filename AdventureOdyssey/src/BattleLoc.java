...
public abstract class BattleLoc extends Location {
    ...
    public boolean getLocation() {
        ...
        System.out.print("<Y>es veya <N>o :");
        ...
        if (selCase.equals("Y")) {
            ...
            if (combat(obsCount)) {
                ...
                if (this.award.equals("Wood Chest") && player.getInv().isFood() == false) {
                    System.out.println(this.award + " Kazandınız! ");
                    player.getInv().setFood(true);
                } else if (this.award.equals("Elite Chest") && player.getInv().isWater() == false) {
                    System.out.println(this.award + " Kazandınız! ");
                    player.getInv().setWater(true);
                } else if (this.award.equals("Royal Chest") && player.getInv().isFirewood() == false) {
                    System.out.println(this.award + " Kazandınız! ");
    ...
    public boolean combat(int obsCount) {
        ...
        for (int i = 0; i < obsCount; i++) {
            ...
            while (player.getHealthy() > 0 && obstacle.getHealth() > 0) {
                ...
                System.out.print("<F>ight veya <B>ack :");
            ...
            if (obstacle.getHealth() < player.getHealthy()) {
                ...
                if (!obstacle.getName().equals("Necromancer")) {
                    ...
                    if (randomNum <= 15) {
                        ...
                        if (randomSilah <= 20) {
                            // Tüfek ödülü kazan.
                            System.out.println("Tebrikler Shard kazandınız.");
                            player.getInv().setDamage(7);
                            player.getInv().setwName("Shard");
                        } else if (randomSilah <= 50) {
                            // Kılıç ödülü kazan.
                            System.out.println("Tebrikler Raptor kazandınız.");
                            player.getInv().setDamage(3);
                            player.getInv().setwName("Raptor");
                        } else {
                            // Tabanca ödülü kazan.
                            System.out.println("Tebrikler Iron Bow kazandınız.");
                            player.getInv().setDamage(2);
                            player.getInv().setwName("Iron Bow");
                        }
                        ...
                        if (randomZırh <= 20) {
                            ...
                            System.out.println("Tebrikler Imperial Zırh kazandınız.");
                            player.getInv().setArmor(5);
                            player.getInv().setaName("Imperial");
                        } else if (randomZırh <= 50) {
                            // Orta zırh ödülü kazan.
                            System.out.println("Tebrikler Shell  Zırh kazandınız.");
                            player.getInv().setArmor(3);
                            player.getInv().setaName("Shell");
                        } else {
                            // Hafif zırh ödülü kazan.
                            System.out.println("Tebrikler Chitin Zırh kazandınız.");
                            player.getInv().setArmor(1);
                            player.getInv().setaName("Chitin");
                        }
