...
public class ToolStore extends NormalLoc {
    ...
    public int armorMenu() {
        System.out.println("1. Chitin Armor \t <Para : 15 - Engellenen Hasar : 1>");
        System.out.println("2. Shell Armor \t <Para : 25 - Engellenen Hasar : 3>");
        System.out.println("3. Imperial Armor \t <Para : 40 - Engellenen Hasar : 5>");
    ...
    public int weaponMenu() {
        System.out.println("1. Shard\t<Para : 25 - Hasar : 2>");
        System.out.println("2. Raptor\t<Para : 35 - Hasar : 3>");
        System.out.println("3. Iron Bow\t<Para : 45 - Hasar : 7>");
        System.out.println("4. Çıkış");
